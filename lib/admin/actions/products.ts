...
export async function createProduct(data: ProductFormData) {
  try {
    ...
    if ((data as any).ogTitle) {
      productData.ogTitle = (data as any).ogTitle
    }
    if ((data as any).ogDescription) {
      productData.ogDescription = (data as any).ogDescription
    }
    if ((data as any).ogImage) {
      productData.ogImage = (data as any).ogImage
    }
    if ((data as any).twitterCard) {
      productData.twitterCard = (data as any).twitterCard
    }
    if ((data as any).twitterTitle) {
      productData.twitterTitle = (data as any).twitterTitle
    }
    if ((data as any).twitterDescription) {
      productData.twitterDescription = (data as any).twitterDescription
    }
    if ((data as any).twitterImage) {
      productData.twitterImage = (data as any).twitterImage
    }
...
export async function deleteProduct(id: string) {
  try {
    ...
    const productOptionsList = await db
 ...
 */
export async function bulkUpdateProductType(
  ids: string[],
  productType: string
) {
  if (ids.length === 0) {
